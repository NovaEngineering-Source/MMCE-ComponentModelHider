...
minecraft {
    ...
    // CoreMod args
    args.add("-Dfml.coreMods.load=com.cleanroommc.multiblocked.core.MultiblockedLoadingPlugin")
    // Mixin args
...
tasks.jar.configure {
    ...
    attributes["FMLCorePlugin"] = "github.kasuminova.mmce.core.ComponentModelHiderPlugin"
...
dependencies {
    ...
    val mixin : String = modUtils.enableMixins("org.spongepowered:mixin:0.8.+", "mixins.component_model_hider.refmap.json").toString()
    api (mixin) {
        isTransitive = false
    }
